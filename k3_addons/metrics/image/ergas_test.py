...
from k3_addons.metrics.image.ergas import (
    error_relative_global_dimensionless_synthesis as error_relative_global_dimensionless_synthesis_keras,
)
from torchmetrics.functional.image.ergas import (
    error_relative_global_dimensionless_synthesis as error_relative_global_dimensionless_synthesis_torch,
)
...
def test_total_variation(input_shape, reduction, data_format):
    ...
    tv_keras = error_relative_global_dimensionless_synthesis_keras(
    ...
    tv_torch = error_relative_global_dimensionless_synthesis_torch(
        inputs, labels, reduction=reduction
    ).numpy()
